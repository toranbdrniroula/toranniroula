...
[Download the full internship report (PDF)](../assets/downloads/iitk-reverse-flow-piv-pod-internship-report.pdf) — mathematical formulation and Python implementation are in the appendices.
...
<img src="../assets/media/work_assets_iitk_reverse_flow_piv_pod/iitk-reverse-flow-piv-pod-workflow.png" alt="PIVlab and Python post-processing and POD workflow diagram">
...
<hero-carousel interval="4000" label="PIVlab processing stages on a single image pair" fit="contain">
