...
This was completed under the FOSSEE Fellowship's OpenFOAM Research Migration Project at IIT Bombay. My thanks to Asst. Prof. Chandan Bose (University of Birmingham) and Asst. Prof. Tushar Chourushi for supervision, CFD Engineer Nikhil Bhamare for mentoring, FOSSEE mentor Manjil Sitoula, and Project Manager Payel Mukherjee — and for the workstation access at IIT Bombay FOSSEE that made the grid convergence and winglet studies possible on top of the baseline replication.
